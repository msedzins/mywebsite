...
Slice is a very powerful and flexible data structure in Golang. It is easy to use and understand, but there are some tricky concepts that might come out in more advanced usages.